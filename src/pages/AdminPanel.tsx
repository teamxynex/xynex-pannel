...
export default function AdminPanel() {
  ...
  type AdminTab = "dashboard" | "database" | "personalization" | "extensions" | "eggs" | "playit" | "users" | "mounts" | "nodes" | "traffic" | "createserver" | "manageserver" | "apikeys" | "activity";
  const validTabs: AdminTab[] = ["dashboard", "createserver", "manageserver", "apikeys", "database", "personalization", "extensions", "eggs", "mounts", "nodes", "traffic", "playit", "users", "activity"];
