      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-foreground mb-2 flex items-center">
            <Network className="w-6 h-6 mr-3 text-theme-400" />
            SFTP Details
          </h2>
        ...
        {!sftpInfo ? (
          <div className="qx-glass border border-border-subtle p-8 rounded-2xl flex flex-col items-center justify-center text-center">
            <div className="w-16 h-16 bg-theme-500/10 rounded-2xl flex items-center justify-center mb-4 border border-theme-500/20">
              <ShieldCheck className="w-8 h-8 text-theme-400" />
            </div>
            ...
            <button
              ...
              className="px-6 py-3 bg-theme-500 hover:bg-theme-600 text-foreground font-bold rounded-xl transition-colors shadow-lg shadow-theme-500/20"
            >
            ...
            <div className="space-y-6">
              <div className="qx-glass border border-border-subtle rounded-2xl p-6 relative overflow-hidden group">
                ...
                <h3 className="text-lg font-bold text-foreground mb-6 flex items-center">
                  <Key className="w-5 h-5 mr-2 text-theme-400" /> Connection Info
                </h3>
                    ...
                    {sftpInfo.password.startsWith("(Hidden") ? (
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <button
                          ...
                          className="px-5 py-3 bg-theme-500 hover:bg-theme-600 text-foreground font-bold rounded-xl transition-colors shadow-lg shadow-theme-500/20 flex items-center justify-center shrink-0 disabled:opacity-50"
                        >
            ...
            <div className="space-y-6">
              <div className="qx-glass border border-border-subtle rounded-2xl p-6">
                ...
                <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                  <p>
                    You can connect to your server's files using an SFTP client such as <a href="https://filezilla-project.org/" target="_blank" rel="noreferrer" className="text-theme-400 hover:underline">FileZilla</a>, <a href="https://winscp.net/" target="_blank" rel="noreferrer" className="text-theme-400 hover:underline">WinSCP</a>, or <a href="https://cyberduck.io/" target="_blank" rel="noreferrer" className="text-theme-400 hover:underline">Cyberduck</a>.
                  </p>
                  ...
                  <div className="p-4 bg-theme-500/5 border border-theme-500/20 rounded-xl text-theme-200/70">
                    <strong className="text-theme-400">Note:</strong> Your SFTP access is isolated. You can only view and modify files within this specific server's directory.
                  </div>
                </div>
              </div>
            </div>
