        ...
        <div className="p-4 bg-muted-subtle">
          ...
          {title === "Crop Background" && (
            <div className="flex gap-2 mb-4">
              <button 
                ...
                className={`flex-1 py-1.5 rounded-lg text-sm font-medium transition-colors ${currentAspect === 16/9 ? "bg-theme-500 text-foreground" : "bg-muted text-muted-foreground hover:bg-muted-hover"}`}
              >
                16:9 (PC)
              </button>
              <button 
                onClick={() => setCurrentAspect(9/16)}
                className={`flex-1 py-1.5 rounded-lg text-sm font-medium transition-colors ${currentAspect === 9/16 ? "bg-theme-500 text-foreground" : "bg-muted text-muted-foreground hover:bg-muted-hover"}`}
              >
                9:16 (Mobile)
              </button>
            </div>
          ...
          <div className="mt-6 flex gap-3 justify-end">
            ...
            <button 
              ...
              className="px-6 py-2 bg-theme-500 hover:bg-theme-600 text-foreground font-semibold rounded-xl transition-colors shadow-[0_0_15px_rgba(99,102,241,0.3)] flex items-center gap-2"
            >
              <Check size={18} /> Apply
            </button>
          </div>
